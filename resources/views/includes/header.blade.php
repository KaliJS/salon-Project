              ...
              <div class="container-fluid">
                <div class="d-flex">
                  ...
                  <div class="d-flex order-lg-2 ml-auto">
                    <a href="Vertical-IconSidedar-Light/#" data-toggle="search" class="nav-link nav-link-lg d-md-none navsearch">
                    ...
                    <div class="dropdown profile-dropdown">
                      <a href="Vertical-IconSidedar-Light/#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
                        <span>
                          <img src="{{ asset('images/2.jpg') }}" alt="img" class="avatar avatar-md brround">
                        </span>
                      </a>
