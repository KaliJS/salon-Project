...
<aside class="app-sidebar ps ps--active-y">
          <div class="app-sidebar__logo">
            <a class="header-brand" href="Vertical-IconSidedar-Light/index">
              <img src="{{asset('users/images/logo-obw1.png')}}" class="header-brand-img desktop-lgo" alt="Admintro logo" style=" height: 4.5rem;
    margin-top: -13px;">
           ...
           @if(in_array("accounts",$permissions))
            <li class="slide">
              ...
              <ul class="slide-menu">
                ...
                <li><a href="{{ url('/admin/quick-payments') }}" class="slide-item">Quick Invoices</a></li>
