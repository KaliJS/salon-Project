            ...
            <div class="page-header">
              <div class="page-leftheader">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="#">Quick Invoices</a></li>
              ...
              <div class="col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Quick Invoices List</h3>
                  </div>
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 mb-4">
                        <a href="{{ route('quick-payments.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Create Invoice</a>
                      </div>
