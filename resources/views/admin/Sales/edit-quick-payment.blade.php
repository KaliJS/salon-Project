            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('quick-payments.update',$quick_payment)}}" method="POST">
                     @method('PUT')
                      @csrf
                      ...
                      <div class="form-group row customerDetails">
                        ...
                        <div class="col-md-9">
                          <input type="text" value="{{$quick_payment->name}}" class="form-control" id="address" name="name">
                        </div>
                      </div>
                      ...
                      <div class="form-group row quantity_no">
                        ...
                        <div class="col-md-9">
                          <input type="number" value="{{$quick_payment->quantity}}" name="quantity" class="form-control" id="inputQuantity" placeholder="Quantity">
                        </div>
                      </div>
                      ...
                      <div class="amountDetails">
                          ...
                          <div class="form-group row  totalAmount">
                            ...
                            <div class="col-md-9">
                              <input type="number" class="form-control" value="{{$quick_payment->total_amount}}" name="total_amount" id="totalAmount" placeholder="Stylist Name" readonly>
                            </div>
                          </div>
                          <div class="form-group row totalAmount">
                            <label for="inputPassword3" class="col-md-3 form-label"><strong>Total Amount: </strong></label>
                            <div class="col-md-9">
                              <input type="number" class="form-control" style="background-color: #705ec8;color: white;font-weight: 700;" value="{{$quick_payment->final_amount}}" name="final_amount" id="totalAmount" placeholder="Stylist Name" readonly>
                            </div>
                          </div>
                      ...
                      <div class="form-group row ">
                        ...
                        <div class="col-md-9">
                          <select class="form-control" name="payment_type" tabindex="-1" aria-hidden="true">
                            ...
                            <option value="Cash" {{$quick_payment->payment_type=='Cash'?'selected':''}}>Cash</option>
                            <option value="Credit Card" {{$quick_payment->payment_type=='Credit Card'?'selected':''}}>Credit Card</option>
                            <option value="Debit Card" {{$quick_payment->payment_type=='Debit Card'?'selected':''}}>Debit Card</option>
                            <option value="Upi" {{$quick_payment->payment_type=='Upi'?'selected':''}}>Upi</option>
                            <option value="Wallet" {{$quick_payment->payment_type=='Wallet'?'selected':''}}>Wallet</option>
                          </select>
                        </div>
                      </div>
