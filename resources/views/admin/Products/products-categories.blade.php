...
@section('content')
            ...
            <div class="page-header">
              <div class="page-leftheader">
                ...
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#"><i class="angle fa fa-angle-right mr-2"></i>Products Categories</a>
                  </li>  
                </ol>
              </div>
            </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6 mb-4">
                        <a href="{{ route('products-categories.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Categories</a>
                      </div>
                              ...
                              <td>
                                <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu" style="">
                                    <a class="dropdown-item" href="{{ url('/admin/products-categories/editCategory/'.$category->id) }}"><i class="fa fa-edit mr-2"></i> Edit</a>
                                    <form action="{{ url('/admin/products-categories/destroyCategory/'.$category->id) }}" method="POST" onsubmit="return confirm('Are you sure , you want to delete this?')">
