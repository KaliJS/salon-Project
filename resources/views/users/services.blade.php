...
@section('content')
        ...
        <div class="page-content">
            ...
            <!-- INNER PAGE BANNER -->
            <div class="wt-bnr-inr overlay-wraper bg-center" style="background-image:url({{url('users/images/21.jpg')}});">
              <div class="overlay-main site-bg-secondry opacity-07"></div>
                <div class="container">
                    <div class="wt-bnr-inr-entry">
                      <div class="banner-title-outer">
                          <div class="banner-title-name">
                            <h2 class="site-text-primary">Our Services</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
                ...
                <div class="container">
                    ...
                    <!-- TITLE END-->
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 m-b30">
                                <div class="wt-box service-box-1">
                                    ...
                                    <div class="service-box-info p-t20 text-center">
                                        ...
                                        <button  class="site-button site-btn-effect mt-3">Book Now</button>
                                    </div>
                                </div>                         
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12 m-b30">
                                <div class="wt-box service-box-1">
                                    ...
                                    <div class="service-box-info p-t20 text-center">
                                        ...
                                        <h3 class="m-b0"><a href="javascript:;" class="site-text-primary">Men Hair Cut</a></h3> 
                                        <button  class="site-button site-btn-effect mt-3">Book Now</button>
                                    </div>
                                </div>                         
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12 m-b30">
                                <div class="wt-box service-box-1">
                                    <div class="service-box-media"><img src="{{asset('users/images/pic1.jpg')}}" alt=""></div>
                                    <div class="service-box-info p-t20 text-center">
                                        <h2 class="text-black">16</h2>      
                                        <h3 class="m-b0"><a href="javascript:;" class="site-text-primary">Yoga Classes and Threrapy</a></h3> 
                                        <button  class="site-button site-btn-effect mt-3">Book Now</button>
                                    </div>
                                </div>                         
                            </div>
            ...
            <!-- CONTACT US START -->
            <div class="section-full p-t80 p-b50 bg-orange-light2">
                <div class="container">
                    <div class="section-content">
